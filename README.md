...
**Founding AI product engineer and technical AI product manager building autonomous agent systems, MCP tooling, bio-AI infrastructure, and production-grade AI workflows.**

I build AI products where agents do useful work inside real engineering, research, and business loops: retrieval, tool use, workflow orchestration, evaluation, observability, runbooks, developer automation, genomics, scientific discovery, and full-stack product delivery.

My strongest work sits at the intersection of **0-to-1 AI product engineering**, **agentic systems**, **high-trust biomedical workflows**, and **technical product ownership**. I scope POCs and MCPs, define product requirements, map user workflows, own roadmaps, build full-stack systems, integrate external tools/APIs, coordinate engineering teams, and ship AI workflows that can be tested, reviewed, launched, and improved.
...
<p>
  ...
  <a href="https://discovering.app"><img alt="Plato Scientific" src="https://img.shields.io/badge/Plato%20Scientific-discovering.app-lightgrey?style=social"></a>
</p>
...
| Product and stakeholder execution | Customer discovery, user workflow mapping, demos, stakeholder review, quality metrics, agent evaluation, and cross-functional coordination |

## Featured Work

| Project | Focus | Why it matters | Proof |
| --- | --- | --- | --- |
| [Nex Copilot / Nex-T1](https://nex-t1.ai) | AI copilot product system | 0-to-1 AI copilot and agentic workflow platform spanning product discovery, roadmap ownership, MCP/tool integrations, full-stack delivery, customer feedback loops, and launch readiness. | [Live product](https://nex-t1.ai) |
| [Nex Copilot Mobile](https://testflight.apple.com/join/TSb64zQy) | Mobile AI product | Mobile product surface for AI-native workflows, built around user access, product iteration, and real-world feedback from community and customer-facing usage. | [TestFlight](https://testflight.apple.com/join/TSb64zQy) |
...
| [Awesome Codex App Template](https://github.com/Eldergenix/awesome-codex-app-template) | AI app starter | Production-oriented monorepo template for AI applications, mobile export setup, and reusable app infrastructure. | [Repo](https://github.com/Eldergenix/awesome-codex-app-template) |
...
- Applying product management discipline to AI systems: customer discovery, user workflow mapping, PRDs, MVP scoping, roadmap sequencing, quality metrics, agent evaluation, launch readiness, and product feedback loops.

## How I Work

| Principle | Operating behavior |
| --- | --- |
| Own the ambiguous middle | I am strongest where product intent, user needs, technical architecture, and delivery risk are not yet cleanly separated. |
| Build from workflow reality | I start with customer discovery, user workflow mapping, product requirements, and the concrete job the AI system must perform. |
| Ship useful systems, not demos | I prioritize production paths, release readiness, feedback loops, observability, documentation, and technical debt tradeoffs. |
| Treat agents as systems | I design around tool boundaries, retrieval quality, structured outputs, approvals, dry runs, postcondition checks, and evaluation loops. |
| Keep humans in the loop where it matters | I build for reviewability, traceability, uncertainty handling, evidence grounding, and safe handoffs between model output and system action. |
| Communicate across functions | I work across founders, customers, engineers, users, marketing, leadership, investors, scientists, and clinicians to keep scope, risks, and outcomes visible. |
...
<p>
  ...
  <img alt="MCP" src="https://img.shields.io/badge/MCP-lightgrey?style=social">
  ...
  <img alt="Redis" src="https://img.shields.io/badge/Redis-lightgrey?style=social&logo=redis">
...
| Cloud and deployment | AWS, Railway, Vercel, CI/CD, deployment recovery, production observability, release support |
| Design and productivity | Figma, Photoshop, Microsoft Excel, Microsoft Word, technical documentation, research artifacts, stakeholder-ready product communication |
| Leadership and delivery | Developer team management, demos and stakeholder review, integration roadmaps, implementation planning, milestone tracking, dependency mapping, blocker surfacing |
