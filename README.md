...
<p>
  ...
  <a href="https://github.com/Eldergenix"><img alt="Yearly activity" src="https://img.shields.io/badge/Yearly%20activity-800%2B%20contributions-lightgrey?style=social&logo=github"></a>
...
| Area | Evidence |
| --- | --- |
| Autonomous agent systems | MCP servers, tool-using runtimes, orchestration loops, permissioned execution, and developer automation |
| Bio-AI and genomics | Genome query tooling, variant-risk interfaces, scientific workflow automation, and peer-reviewed publications |
| Production engineering | CI review agents, incident-response automation, deployment recovery, observability loops, and full-stack applications |
| Applied AI infrastructure | Retrieval, evaluation, model/tool routing, research copilots, Web3 agents, and secure execution workflows |
